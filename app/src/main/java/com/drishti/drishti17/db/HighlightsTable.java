...
public class HighlightsTable {
    ...
    public static int insert(Context context, HighLightModel highLightModel) {
        ...
        int[] passInt = {highLightModel.server_id};
        return insert(context, passString, passInt);
    }
    ...
    public static List<HighLightModel> getHightLight(Context context, String selection,
        ...
        while (hightlightCursor.moveToNext()) {
            ...
            int server_id = hightlightCursor.getInt(hightlightCursor.getColumnIndex(columnNames[0][1]));
            ...
            HighLightModel model = new HighLightModel(name, promo, image, id, server_id);
